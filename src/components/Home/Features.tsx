        ...
        <section className="py-12 bg-white sm:py-16 lg:py-20">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto text-center">
                    <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">All features
                        for one price. Try Rareblocks for free!</h2>
                </div>
                            ...
                            <div className="md:flex md:items-center md:space-x-12 lg:space-x-24">
                                ...
                                <div className="block md:hidden lg:block">
                                    <div className="hidden lg:block">
                                        <svg className="w-4 h-auto text-gray-600" viewBox="0 0 16 123" fill="none"
                                    ...
                                    <div className="block mt-10 md:hidden">
                                        <svg className="w-auto h-4 text-gray-600" viewBox="0 0 172 16" fill="none"
                                             stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                                            <line y1="-0.5" x2="18.0278" y2="-0.5"
                ...
                <div
                    className="max-w-2xl mx-auto mt-12 text-center sm:mt-16 sm:flex sm:items-start sm:justify-center sm:text-left">
                    <img className="flex-shrink-0 object-cover mx-auto rounded-full w-28 h-28 sm:mx-0"
                         src="https://cdn.rareblocks.xyz/collection/clarity/images/pricing/6/avatar-male.png"
                         alt=""/>
                    <div className="mt-6 sm:mt-0 sm:ml-12">
                        <blockquote>
                            <p className="text-lg font-normal leading-relaxed text-gray-900 font-pj">“You made it so
                                simple. My new site is so much faster and easier to work with than my old site. I
                                just choose the page, make the change.”</p>
                        </blockquote>
