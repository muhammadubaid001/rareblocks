                ...
                <div className="grid grid-cols-2 mt-16 sm:grid-cols-3 gap-y-16 lg:grid-cols-6 gap-x-16">
                    <div>
                        ...
                        <ul className="mt-8 space-y-5">
                            ...
                            <li>
                                <a href="#" title=""
                                   className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"> Features </a>
                            </li>

                            <li>
                                <a href="#" title=""
                                   className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"> Works </a>
                            </li>

                            <li>
                                <a href="#" title=""
                                   className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"> Career </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-8 space-y-5">
                            <li>
                                <a href="#" title=""
                                   className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"> Customer
                                    Support </a>
                            </li>

                            <li>
                                <a href="#" title=""
                                   className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"> Delivery
                                    Details </a>
                            </li>
                    ...
                    <div className="col-span-2 sm:col-span-1">
                        ...
                        <ul className="mt-8 space-y-5">
                            <li>
                                <a href="#" title=""
                                   className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"> Free
                                    eBooks </a>
                            </li>

                            <li>
                                <a href="#" title=""
                                   className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"> Development
                                    Tutorial </a>
                            </li>

                            <li>
                                <a href="#" title=""
                                   className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"> How
                                    to - Blog </a>
                            </li>

                            <li>
                                <a href="#" title=""
                                   className="inline-flex text-sm font-normal text-gray-900 transition-all duration-300 transform font-pj hover:text-gray-600 hover:translate-x-1"> Youtube
                                    Playlist </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="col-span-2 sm:col-span-3 xl:pl-20">
                        ...
                        <div className="grid grid-cols-1 mt-8 gap-y-8 sm:grid-cols-2 sm:gap-x-16">
                            <div>
                                <h6 className="text-sm font-bold tracking-widest text-gray-900 uppercase font-pj">Call
                                    us</h6>
                            ...
                            <div>
                                <h6 className="text-sm font-bold tracking-widest text-gray-900 uppercase font-pj">Email
                                    us</h6>
                                <p className="mt-2.5 text-xl font-pj text-gray-900 font-bold">
                                    <a href="#" title=""> info@rareblocks.xyz </a>
                                </p>
                            </div>
                        </div>
                    </div>
